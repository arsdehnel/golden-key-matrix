		...
		<>
			...
			<div className="osn-welcome-view">
				<div className="osn-welcome-panel">
					...
					<p>
						If you don't mind please scan this QR code and take this super quick two "question" survey so we can gauge
						the room's experience and roles related to the topic. We aren't storing the data outside of a server-side
						state object and you can provide a fake name!
					</p>
