	...
	return (
		<StandardLayout siteSection="home">
			...
			<p>
				...
				— each connected to outcomes that matter to both the people building the product and the people paying for it. The{" "}
				<a href="/matrix">Matrix</a> ties it together as a lightweight self-assessment: a place to gauge where things
			...
			<p>
				...
				living version — the thinking outside the slides. We'd love to hear how it resonates (or doesn't) with what you've
				seen in your own work.
			</p>
		</StandardLayout>
	);
}
