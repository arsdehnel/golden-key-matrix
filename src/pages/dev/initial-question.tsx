...
import HostViewClient from "@/components/dev/host-view-client";
import { sessions } from "@/session/store";

export default async function InitialQuestion({
	request,
	response,
	...
	const pollUrl = `${new URL(request.url).origin}/dev/initial-question`;
	return <HostViewClient pollUrl={pollUrl} sessionId={sessionId} />;
}
